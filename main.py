...
import sqlite3
import hashlib  # Для генерации коротких ключей кнопок
...
PORT = int(os.getenv("PORT", 8000))  # Исправлено на 8000 (как в логах Gunicorn)
    ...
    if cursor.fetchone()[0] == 0:
        products = [
            ...
            (
                ...
                0.0,
                "Рулонные шторы",
                "images/rulonnye_den_noch.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            (
                ...
                0.0,
                "Рулонные шторы",
                "images/rulonnye_zebra.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            (
                ...
                0.0,
                "Рулонные шторы",
                "images/rulonnye_blackout.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            ...
            (
                ...
                0.0,
                "Горизонтальные жалюзи",
                "images/gorizontalnye_aluminievye.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            (
                ...
                0.0,
                "Горизонтальные жалюзи",
                "images/gorizontalnye_derevyannye.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            ...
            (
                ...
                0.0,
                "Вертикальные жалюзи",
                "images/vertikalnye_tkanevye.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            (
                ...
                0.0,
                "Вертикальные жалюзи",
                "images/vertikalnye_pvh.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            ...
            (
                ...
                0.0,
                "Жалюзи плиссе",
                "images/plisse_tkanevye.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            (
                ...
                0.0,
                "Жалюзи плиссе",
                "images/plisse_aluminievye.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            ...
            (
                ...
                0.0,
                "Деревянные жалюзи",
                "images/derevyannye_dub.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            ),
            (
                ...
                0.0,
                "Деревянные жалюзи",
                "images/derevyannye_orekh.jpg"  # ← ЛОКАЛЬНЫЙ ФАЙЛ
            )
        ]
...
def handle_category_selection(call):
    try:
        ...
        for product in products:
            ...
            # Генерируем короткий ключ для кнопок (чтобы избежать BUTTON_DATA_INVALID)
            ...
            # Отправляем фото: если путь локальный — открываем файл, иначе — по URL
            try:
...
def handle_inline_button(call):
    try:
        # Здесь можно реализовать логику для details и order
        # Пока просто отправим сообщение
        bot.answer_callback_query(call.id)
        bot.send_message(call.message.chat.id, "Функция в разработке. Пожалуйста, воспользуйтесь кнопкой '🛒 Заказать' в главном меню.")
    except Exception as e:
...
def home():
    ...
    if not _INITIALIZED:
        ...
        start_autoposting()
        _INITIALIZED = True
    return jsonify({"status": "running", "version": "2.2"}), 200
