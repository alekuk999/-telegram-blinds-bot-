...
# === 🚀 Глобальная инициализация бота и job_queue ===
application = None
job_queue = None

async def init_bot():
    global application, job_queue
    try:
        # Создаём приложение
        ...
        if job_queue is None:
            raise RuntimeError("❌ Не удалось инициализировать job_queue")
        ...
        logger.info("✅ Бот и job_queue успешно инициализированы")
    except Exception as e:
