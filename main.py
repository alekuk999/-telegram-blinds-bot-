...
CHANNEL_ID = "@astra_jaluzi"  # Ваш канал
PORT = 8000  # Обязательно 8000 для TimeWeb Cloud
...
def add_sample_data():
    ...
    if cursor.fetchone()[0] == 0:
        products = [
            ("Рулонные шторы день-ночь", "✨ *Идеально для спальни и гостиной!*\n\n• Чередование прозрачных и плотных полос\n• Материал: полиэстер с пропиткой\n• Цвета: белый, бежевый, серый, графит\n• Размеры: от 40 до 300 см", 0.0, "Рулонные шторы", "images/rulonnye_den_noch.jpg"),
            ("Рулонные шторы зебра", "🎨 *Современный дизайн с эффектом зебры!*\n\n• Два слоя ткани — игра света и тени\n• Управление: цепочка или пружинный механизм\n• Применение: кухня, детская, офис\n• Гарантия: 3 года", 0.0, "Рулонные шторы", "images/rulonnye_zebra.jpg"),
            ("Рулонные шторы блэкаут", "🌙 *Полное затемнение для комфортного сна!*\n\n• 100% затемнение — идеально для спальни\n• Трёхслойная ткань с алюминиевым покрытием\n• Цвета: чёрный, тёмно-серый, шоколад, бордо\n• Монтаж: внутри или снаружи проёма", 0.0, "Рулонные шторы", "images/rulonnye_blackout.jpg"),
            ("Горизонтальные жалюзи алюминиевые", "🔧 *Классика, проверенная временем!*\n\n• Ламели 25 мм — лёгкие и прочные\n• Цвета: белый, серебро, золото, дерево, металлик\n• Управление: поворот на 180°\n• Применение: кухня, ванная, балкон", 0.0, "Горизонтальные жалюзи", "images/gorizontalnye_aluminievye.jpg"),
            ("Горизонтальные жалюзи деревянные", "🪵 *Натуральная эстетика и экологичность!*\n\n• Материал: дуб, орех, бук\n• Служат 10+ лет — не деформируются\n• Стиль: «кантри», «эко», «лофт»\n• Уход: протирайте сухой тряпкой", 0.0, "Горизонтальные жалюзи", "images/gorizontalnye_derevyannye.jpg"),
            ("Вертикальные жалюзи тканевые", "🌿 *Элегантность и уют в вашем доме!*\n\n• Ткань: плотный полиэстер\n• Управление: плавный поворот и сдвиг\n• Цвета: бежевый, серый, молочный, лаванда\n• Применение: гостиная, спальня, офис", 0.0, "Вертикальные жалюзи", "images/vertikalnye_tkanevye.jpg"),
            ("Вертикальные жалюзи ПВХ", "💧 *Практично и бюджетно!*\n\n• Материал: пластиковые ламели\n• Влагостойкие — не боятся пара и брызг\n• Уход: протрите влажной тряпкой\n• Цвета: белый, бежевый, серый, имитация дерева", 0.0, "Вертикальные жалюзи", "images/vertikalnye_pvh.jpg"),
            ("Жалюзи плиссе тканевые", "🎨 *Изысканный дизайн для нестандартных окон!*\n\n• Форма: гармошка — идеальны для мансард\n• Материал: ткань с эффектом «плиссе»\n• Управление: ручное или автоматическое\n• Цвета: пастельные тона", 0.0, "Жалюзи плиссе", "images/plisse_tkanevye.jpg"),
            ("Жалюзи плиссе алюминиевые", "🪟 *Современно и функционально!*\n\n• Алюминиевые ламели с тканевым покрытием\n• Отражают солнечные лучи — снижают нагрев\n• Цвета: белый, серебро, золото, бронза\n• Применение: офисы, панорамные окна", 0.0, "Жалюзи плиссе", "images/plisse_aluminievye.jpg"),
            ("Деревянные жалюзи дуб", "🌳 *Натуральная роскошь и статус!*\n\n• Материал: натуральный дуб\n• Служат 15+ лет — не выцветают\n• Стиль: «кантри», «эко», «премиум»\n• Уход: протирайте сухой тряпкой", 0.0, "Деревянные жалюзи", "images/derevyannye_dub.jpg"),
            ("Деревянные жалюзи орех", "🌰 *Тёплый и уютный интерьер!*\n\n• Материал: натуральный орех\n• Подчёркивает уют и тепло\n• Идеальны для гостиной и спальни\n• Уход: протирайте сухой тряпкой", 0.0, "Деревянные жалюзи", "images/derevyannye_orekh.jpg")
        ]
...
def home():
    ...
    if not _INITIALIZED:
        init_db()
        add_sample_data()
        # 🔥 ЖЁСТКО ЗАДАННЫЙ ДОМЕН ДЛЯ TIMEWEB CLOUD
        ...
        _INITIALIZED = True
    return jsonify({"status": "running", "service": "BlindStyle Bot", "version": "final"}), 200
