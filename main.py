...
# 🔥 ИСПРАВЛЕНО: Теперь используется ваш реальный канал @astra_jaluzi
...
def init_db():
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS smm_content (
            ...
            weekday INTEGER,  -- 0=Понедельник, 1=Вторник, ... 6=Воскресенье
            created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
        )
    ''')
...
def add_sample_data():
    ...
    if cursor.fetchone()[0] == 0:
        products = [
            ...
            (
                ...
                0.0,
                "Рулонные шторы",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/1c8/1c8d1c8d1c8d1c8d1c8d1c8d1c8d1c8d.jpg"
            ),
            (
                ...
                0.0,
                "Рулонные шторы",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/2a3/2a3e2a3e2a3e2a3e2a3e2a3e2a3e2a3e.jpg"
            ),
            (
                ...
                0.0,
                "Рулонные шторы",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/3b4/3b4f3b4f3b4f3b4f3b4f3b4f3b4f3b4f.jpg"
            ),
            ...
            (
                ...
                0.0,
                "Горизонтальные жалюзи",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/4c5/4c5g4c5g4c5g4c5g4c5g4c5g4c5g4c5g.jpg"
            ),
            (
                ...
                0.0,
                "Горизонтальные жалюзи",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/5d6/5d6h5d6h5d6h5d6h5d6h5d6h5d6h5d6h.jpg"
            ),
            ...
            (
                ...
                0.0,
                "Вертикальные жалюзи",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/6e7/6e7i6e7i6e7i6e7i6e7i6e7i6e7i6e7i.jpg"
            ),
            (
                ...
                0.0,
                "Вертикальные жалюзи",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/7f8/7f8j7f8j7f8j7f8j7f8j7f8j7f8j7f8j.jpg"
            ),
            ...
            (
                ...
                0.0,
                "Жалюзи плиссе",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/8g9/8g9k8g9k8g9k8g9k8g9k8g9k8g9k8g9k.jpg"
            ),
            (
                ...
                0.0,
                "Жалюзи плиссе",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/9h0/9h0l9h0l9h0l9h0l9h0l9h0l9h0l9h0l.jpg"
            ),
            ...
            (
                ...
                0.0,
                "Деревянные жалюзи",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/0i1/0i1m0i1m0i1m0i1m0i1m0i1m0i1m0i1m.jpg"
            ),
            (
                ...
                0.0,
                "Деревянные жалюзи",
                "https://xn----8sbemcgkdfi5al3k.xn--p1ai/upload/iblock/1j2/1j2n1j2n1j2n1j2n1j2n1j2n1j2n1j2n.jpg"
            )
        ]
    ...
    if cursor.fetchone()[0] == 0:
        smm_content = [
            ("5 причин выбрать рулонные шторы", "Рулонные шторы - идеальное решение для современного интерьера. Они практичны, красивы и функциональны!", "https://placehold.co/600x400/4b6cb7/white?text=Рулонные+шторы", "Образование", None, 1, None),
            ("Как выбрать жалюзи для кухни", "Кухня требует особого подхода к выбору жалюзи. Рассказываем, на что обратить внимание!", "https://placehold.co/600x400/182848/white?text=Жалюзи+для+кухни", "Советы", None, 1, None),
            ("Тренды 2023: Что в моде у штор", "Следите за модой и в интерьере! Рассказываем о главных трендах в мире штор этого года.", "https://placehold.co/600x400/ff6b6b/white?text=Тренды+2023", "Тренды", None, 1, None),
            ("Сравнение материалов: Ткань vs ПВХ", "Какой материал выбрать для рулонных штор? Разбираемся в плюсах и минусах каждого варианта.", "https://placehold.co/600x400/27ae60/white?text=Материалы", "Образование", None, 1, None),
            ("Дизайн спальни с идеальными шторами", "Создайте уютную атмосферу в спальне с помощью правильно подобранных штор!", "https://placehold.co/600x400/f39c12/white?text=Дизайн+спальни", "Дизайн", None, 1, None)
        ]
...
def open_channel(message):
    try:
        ...
        # 🔥 ИСПРАВЛЕНО: Теперь ссылка ведёт на @astra_jaluzi
        bot.reply_to(
            message,
...
def send_scheduled_posts():
    """Фоновая задача: публикует посты в канале по расписанию и дню недели"""
    ...
    while True:
        try:
            ...
            # Ищем неопубликованный пост, подходящий по времени И дню недели
            cursor.execute("""
...
#{category.replace(' ', '_')}
                ...
                try:
                    ...
                    conn.commit()
                    print(f"✅ [AUTOPOST] Пост опубликован: {title} (День недели: {current_weekday})")
                except Exception as e:
...
# === Главная страница (health-check и инициализация) ===
@app.route('/')
def home():
    global _INITIALIZED
    if not _INITIALIZED:
        print("🔄 [INIT] Начинаем инициализацию при первом запросе...")
        init_db()
        add_sample_data()
        set_webhook()
        start_autoposting()
