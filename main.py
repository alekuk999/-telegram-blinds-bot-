...
PORT = int(os.getenv("PORT", 8000))  # ⚠️ Убедитесь, что в TimeWeb Cloud PORT=8000
...
# === Установка вебхука ===
def set_webhook():
    # 🛠 ИСПРАВЛЕНО: Используем ваш домен по умолчанию
    hostname = os.getenv('HOSTNAME', 'alekuk999-telegram-blinds-bot--f681.twc1.net')
    webhook_url = f"https://{hostname}:8000/webhook"  # 🛠 ИСПРАВЛЕНО: Корректный URL
