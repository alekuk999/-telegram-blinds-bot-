...
def set_webhook():
    ...
    hostname = os.getenv('HOSTNAME', 'your-app.twc1.net').strip()  # ← ЗАМЕНИ НА СВОЙ ДОМЕН!
    # 🔥 ИСПРАВЛЕНО: УБРАН ПРОБЕЛ ПОСЛЕ https://
...
# ❗ ВАЖНО: Инициализация больше НЕ вызывается здесь!
